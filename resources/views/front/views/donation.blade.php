    ...
    <div class="flex flex-col z-30">
        <div id="content" class="w-full min-h-[calc(100vh-220px)] h-full bg-white rounded-t-[40px] flex flex-col gap-[30px] p-[30px_24px_30px]">
            ...
            <div class="grid grid-cols-2 w-fit mx-auto justify-center gap-[30px]">
                <a href="{{route('front.checkout', ['fundraising' => $fundraising->slug, 'totalAmountDontaion' => 15000] )}}" class="w-[150px] flex flex-col gap-4 p-4 rounded-[30px] border border-[#E8E9EE] items-center">
                ...
                <a href="{{route('front.checkout', ['fundraising' => $fundraising->slug, 'totalAmountDontaion' => 50000] )}}" class="w-[150px] flex flex-col gap-4 p-4 rounded-[30px] border border-[#E8E9EE] items-center">
                    <div class="w-10 h-10 flex shrink-0 overflow-hidden">
                        <img src="{{asset('assets/images/icons/smile.svg')}}" alt="icon">
                    </div>
                    <span class="font-bold text-lg">Rp 50.000</span>
                </a>
                <a href="{{route('front.checkout', ['fundraising' => $fundraising->slug, 'totalAmountDontaion' => 250000] )}}" class="w-[150px] flex flex-col gap-4 p-4 rounded-[30px] border border-[#E8E9EE] items-center">
                    <div class="w-10 h-10 flex shrink-0 overflow-hidden">
                        <img src="{{asset('assets/images/icons/love.svg')}}" alt="icon">
                    </div>
                    <span class="font-bold text-lg">Rp 250.000</span>
                </a>
                <a href="{{route('front.checkout', ['fundraising' => $fundraising->slug, 'totalAmountDontaion' => 500000] )}}" class="w-[150px] flex flex-col gap-4 p-4 rounded-[30px] border border-[#E8E9EE] items-center">
                    <div class="w-10 h-10 flex shrink-0 overflow-hidden">
                        <img src="{{asset('assets/images/icons/cool.svg')}}" alt="icon">
                    </div>
                    <span class="font-bold text-lg">Rp 500.000</span>
                </a>
                <a href="{{route('front.checkout', ['fundraising' => $fundraising->slug, 'totalAmountDontaion' => 700000] )}}" class="w-[150px] flex flex-col gap-4 p-4 rounded-[30px] border border-[#E8E9EE] items-center">
                    <div class="w-10 h-10 flex shrink-0 overflow-hidden">
                        <img src="{{asset('assets/images/icons/smile.svg')}}" alt="icon">
                    </div>
                    <span class="font-bold text-lg">Rp 700.000</span>
                </a>
                <a href="{{route('front.checkout', ['fundraising' => $fundraising->slug, 'totalAmountDontaion' => 1000000] )}}" class="w-[150px] flex flex-col gap-4 p-4 rounded-[30px] border border-[#E8E9EE] items-center">
                    <div class="w-10 h-10 flex shrink-0 overflow-hidden">
                        <img src="{{asset('assets/images/icons/love.svg')}}" alt="icon">
                    </div>
